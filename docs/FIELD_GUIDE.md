...
**Purpose**: Business-focused explanation of all fields from `data.csv` (72 base fields) plus IV-enriched fields
...
**For technical implementation details, see the docs folder.**
