...
export const kpiTooltips: TooltipSection = {
  ...
  sampleSize: {
    ...
    content: 'Historical validation sample size for the score range of your filtered options. Larger samples provide higher statistical confidence in the models\' predictions. Our TA ML Model is validated on 7.4M+ out-of-sample records (8.76M trained, May 2026 retrain), and the Probability Optimization Model on 72K+ tracked options.',
  },
  showing: {
...
export const validationTooltips: TooltipSection = {
  hitRate77: {
    ...
    content:
      'Empirically observed outcomes at 70-80% prediction range:\n• Probability Optimization Model: 83.8% (19,830 options analyzed)\n• TA ML Model: 70.06% (1,617,173 out-of-sample predictions, May 2026 retrain)\n\n**Based on:** 7.4M+ out-of-sample records (April 2024 - January 2026); TA ML trained on 8.76M records\n\n**DTE note:** 70.06% is weighted average across all DTE. Short-dated (0-35 DTE): ~77%; Far-dated (36+ DTE): ~54%\n\n**Interpretation:** \n• Probability Optimization Model: 83.8% success rate means 16.2% failure rate\n• TA ML: 70.06% success rate means 29.94% failure rate\nPremium gains offset by occasional losses.\n\n**Risk Management:** Position sizing must account for failure rate. Average loss when wrong = strike distance.\n\n**Why 70-80%?** Higher premiums than conservative 80%+ range (which has 86%+ Actual Worthless % but lower premiums)',
  },
  walkForwardAUC: {
