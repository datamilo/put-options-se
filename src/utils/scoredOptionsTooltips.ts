...
export const calibrationTooltips: TooltipSection = {
  overview: {
    ...
    content:
      'These tables show actual Actual Worthless %s (% worthless) achieved at each predicted probability level.\n\n**What This Answers:** "When the model predicts 70-80% probability, how often do options actually expire worthless?"\n\n**Key Finding:** Both models independently validated at the 70-80% prediction range:\n• Probability Optimization Model: 83.8% Actual Worthless % (19,830 samples)\n• TA ML Model: 76.6% Actual Worthless % (636,639 samples)\n\n**THE 32x SAMPLE SIZE DIFFERENCE - Why It Exists:**\n\n**Data Available to Each Model:**\n• V2.1: 72,469 total options (Probability Tracking System)\n  → 19,830 at 70-80% (27% of available data)\n• TA Model: 1,860,935 total options (comprehensive historical database - all Swedish equity options)\n  → 636,639 at 70-80% (27% of available data)\n• Ratio: TA Model has 25.6x more total data available\n\n**Why the Difference:**\n• V2.1 limited to options actively tracked with historical probability snapshots\n• TA Model uses all Swedish options ever traded (April 2024 - Jan 2026)\n• NOT a data quality issue - simply different data sources\n• Both use same 27% distribution at 70-80%, confirming natural market spread\n\n**Statistical Impact:**\n• V2.1 confidence interval: ±0.53 pp (19,830 samples)\n• TA Model confidence interval: ±0.11 pp (636,639 samples)\n• Larger sample = tighter precision, not higher accuracy',
  },
  premiumZone: {
  ...
  dualModelConvergence: {
    title: 'Understanding the 32x Sample Size & Hit Rate Difference',
    content:
      'Both models show strong Actual Worthless % at 70-80%, but with 32x different sample sizes and different hit rates:\n• Probability Optimization (V2.1): 83.8% (19,830 samples)\n• TA ML Model (V3): 76.6% (636,639 samples)\n\n**THE FUNDAMENTAL REASON FOR 32x DIFFERENCE:**\n\n**V2.1 Data Source:** Probability Tracking System\n• Total available: 72,469 options\n• At 70-80%: 19,830 options (27% of available)\n• Limited to options with complete historical probability snapshots\n\n**TA Model Data Source:** Comprehensive Historical Database\n• Total available: 1,860,935 options (ALL Swedish equity options)\n• At 70-80%: 636,639 options (27% of available)\n• Includes all options, not just tracked ones\n\n**Why Different Hit Rates Are Expected:**\n\n**V2.1: 83.8% (Optimized for Tracking System)**\n• In-sample calibration (optimizes weights on tracked options)\n• Represents how formula performs on options we actively track\n• Higher rate because formula is calibrated to tracking system\n\n**TA Model: 76.6% (Realistic for All Options)**\n• Walk-forward validation (predicts on future unseen options)\n• Represents realistic expectation for any new option\n• More conservative because it must work on unknown options\n\n**Key Insight:**\n✓ Different data sources = different populations being tested\n✓ Different methodologies = different testing purposes\n✓ Both hit rates are statistically valid\n✓ V2.1 better for tracking portfolio; TA Model better for new opportunities',
  },
