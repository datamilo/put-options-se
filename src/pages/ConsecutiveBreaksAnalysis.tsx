  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Warning Banner */}
        {analysis?.warning && (
          <div className="w-full bg-yellow-50 dark:bg-yellow-950 border-l-4 border-yellow-500 p-4 rounded-lg mb-8">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-sm font-medium text-yellow-900 dark:text-yellow-200 mb-1">
                  Insufficient Data for This Analysis Period
                </h3>
                <p className="text-sm text-yellow-800 dark:text-yellow-300 mb-2">
                  {analysis.warning.message}
                </p>
                {analysis.warning.suggestedPeriod && analysis.warning.suggestedPeriod !== parseInt(period) && (
                  <button
                    onClick={() => setPeriod(String(analysis.warning.suggestedPeriod))}
                    className="text-sm font-medium text-yellow-700 dark:text-yellow-300 underline hover:text-yellow-900 dark:hover:text-yellow-100"
                  >
                    Try {analysis.warning.suggestedPeriod}-day period instead →
                  </button>
                )}
              </div>
            </div>
