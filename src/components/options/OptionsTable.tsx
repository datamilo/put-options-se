...
export const OptionsTable = ({ data, onRowClick }: OptionsTableProps) => {
  ...
  const columnGroups = {
    basic: ['StockName', 'OptionName', 'Premium', 'StrikePrice', 'DaysToExpiry', 'StockPrice'],
    risk: ['ProbOfWorthless', 'ProbCalibrated', 'EstimatedProbAboveStrike', 'ProbFinal_Weighted', 'ProbWorthless_Bayesian_IsoCal'],
