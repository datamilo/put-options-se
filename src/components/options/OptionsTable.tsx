...
export const OptionsTable = ({ data, onRowClick }: OptionsTableProps) => {
  ...
  const columnGroups = {
    basic: ['StockName', 'OptionName', 'FinancialReport', 'X-Day', 'Premium', '1_2_3_ProbOfWorthless_Weighted', '1_ProbOfWorthless_Original', '2_ProbOfWorthless_Calibrated', '3_ProbOfWorthless_Historical_IV','ProbWorthless_Bayesian_IsoCal'],
