        ...
        <Table>
          <TableHeader>
            <TableRow>
              {visibleColumns.map(column => (
                <TableHead key={column} className={column === 'StockName' ? "w-20 max-w-22" : "min-w-[120px]"}>
                  <Button
                    variant="ghost"
          ...
          <TableBody>
            {filteredData.map((option, index) => (
              ...
              >
                {visibleColumns.map(column => (
                  <TableCell key={column} className={column === 'StockName' ? "w-20 max-w-22 truncate" : "min-w-[120px]"}>
