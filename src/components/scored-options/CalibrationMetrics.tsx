        ...
        <div className="space-y-4">
          <div className="bg-gray-50 dark:bg-gray-900 rounded p-4">
            <p className="text-sm text-gray-700 dark:text-gray-300">
              ...
              Historical Peak (30%), and Support Strength (10%). This table shows the actual hit rate achieved at each
              prediction range across 934K+ expired options.
            </p>
          </div>
      ...
      {activeTab === 'v3' && (
        <div className="space-y-4">
          <div className="bg-gray-50 dark:bg-gray-900 rounded p-4 space-y-3">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              <strong>Walk-forward validation:</strong> Each prediction was made on truly future data, providing the
              most rigorous proof that the model's predictions match reality. This is why we trust these hit rates for
              real-world trading.
            </p>
          </div>
          <BucketCalibrationTable
